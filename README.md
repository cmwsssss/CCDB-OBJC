...
# CCDB-OBJC
CCDB-OBJC is a high-performance database framework based on Sqlite3, MMAP and OBJC written to enable users to perform the simplest and fastest data processing operations at the application level.
